...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[#0f0f11] text-white pt-16 pb-10 px-6 md:px-10 overflow-hidden">
      
      {/* Soft top gradient */}
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-transparent to-black/20 pointer-events-none" />
...
>
  ...
  >
    ...
    >
      ...
      {/* Bottom Bar */}
      <div className="relative z-20 border-t border-white/10 mt-12 pt-6 text-center text-gray-500 text-sm">
