...
_s(Navbar, "gkdFbvUCv9ReAc81aezLAgS5DUI=");
_c = Navbar;
var _c;
...
function Team() {
    ...
    const [enableTransition, setEnableTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const isButtonAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    /* ---------- SEAMLESS LOOP RESET ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Team.useEffect": ()=>{
            if (index === total) {
    ...
    /* ---------- RE-ENABLE TRANSITION ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Team.useEffect": ()=>{
            if (!enableTransition) {
...
_s(Team, "0qeBdHxlyyTUcmqPHaEEeRoQIMQ=");
_c = Team;
var _c;
...
function Testimonials() {
    ...
    /* ---------- RESPONSIVE ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Testimonials.useEffect": ()=>{
            const updateCards = {
                "Testimonials.useEffect.updateCards": ()=>{
            ...
            return ({
                "Testimonials.useEffect": ()=>window.removeEventListener("resize", updateCards)
            })["Testimonials.useEffect"];
        }
    }["Testimonials.useEffect"], []);
    /* ---------- AUTO SCROLL ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Testimonials.useEffect": ()=>{
            intervalRef.current = setInterval({
                "Testimonials.useEffect": ()=>{
                    if (pausedRef.current) return;
                    setIndex({
                        "Testimonials.useEffect": (prev)=>prev + 1
                    }["Testimonials.useEffect"]);
                }
            }["Testimonials.useEffect"], 3000);
            return ({
                "Testimonials.useEffect": ()=>{
                    if (intervalRef.current) clearInterval(intervalRef.current);
                }
    ...
    /* ---------- SEAMLESS LOOP RESET ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Testimonials.useEffect": ()=>{
            if (index === total) {
                ...
                }["Testimonials.useEffect"], TRANSITION_MS);
            }
        }
    }["Testimonials.useEffect"], [
        index,
    ...
    /* ---------- RE-ENABLE TRANSITION ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Testimonials.useEffect": ()=>{
            if (!enableTransition) {
                requestAnimationFrame({
                    "Testimonials.useEffect": ()=>setEnableTransition(true)
                }["Testimonials.useEffect"]);
            }
        }
    }["Testimonials.useEffect"], [
...
_s(Testimonials, "8RMMgS3l/9J6ZMlKE3ICRvpMalM=");
_c = Testimonials;
var _c;
...
//# sourceMappingURL=components_16710f21._.js.map